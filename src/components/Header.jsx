  ...
  return (
    <header className="bg-secondary rounded-full mx-auto max-w-7xl mt-8 px-8 py-4 flex items-center justify-between shadow-sm relative z-20">
      <div className="flex items-center">
        <img src="/logo-header.png" alt="ByKatino Logo" className="h-10" />
      </div>

      <nav className="hidden md:flex items-center space-x-12">
        <a href="#produtos" className="text-primary font-semibold text-sm hover:text-tertiary transition-colors">
          Meus produtos
        </a>
        <a href="#sobre" className="text-primary font-semibold text-sm hover:text-tertiary transition-colors">
          Sobre mim
        </a>
        <a href="#contato" className="text-primary font-semibold text-sm hover:text-tertiary transition-colors">
          Contato
        </a>
      </nav>
